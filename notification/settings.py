...
SECRET_KEY = 'django-insecure--wvyy6mcy8f28teajqislegf(y@)1b#95!a*^9(8d54e^=a%0('
...
DATABASES = {
    'default': {
        ...
        'NAME': 'orders',  # El nombre de la base de datos 
        'USER': 'postgres',  # El usuario definido 
        'PASSWORD': 'academyjava',  # La contraseña definida
        'HOST': 'localhost',  # El nombre del servicio de PostgreSQL
